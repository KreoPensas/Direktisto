...
void boilerplate() {
  ...
  tft.drawRect(0, 0, 79, 39, DIMMED);
  tft.setTextColor(DIMMED);
  tft.setCursor(20, 13);
  tft.print("Song");
  tft.drawRect(80, 0, 79, 39, DIMMED);
  tft.setTextColor(DIMMED);
  ...
  tft.drawRect(160, 0, 79, 39, DIMMED);
  tft.setTextColor(DIMMED);
  ...
  tft.setTextColor(DIMMED);
  tft.setCursor(254, 13);
  tft.print("Utilities");
  tft.drawRect(280, 138, 39, 39, DIMMED);
  tft.drawRect(240, 138, 39, 39, DIMMED);
