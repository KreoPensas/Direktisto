void buttonCheck() {
  ...
  if (touchX > 80 && touchX < 120 && touchY < 40  ) {
    ...
    if ( (screen == 0 && moreScreensFlag == false) || screen == 27 ) {
      sequencer();
    }
  ...
  if (touchX > 160 && touchX < 200 && touchY < 40) {
    ...
    if ( (screen == 0 && moreScreensFlag == false ) || screen == 28 ) {
      harmonize();
    }
  ...
  if (touchX > 240 && touchX < 280 && touchY < 40) {
    ...
    if (screen == 27 && sequencerFlag == true) {
  ...
  if (touchX > 40 && touchX < 80 && touchY > 80 && touchY < 120) {
    ...
    if (bigScreen == true) {
      seqEnable[screen - 1][bigScreenChan] = !seqEnable[screen - 1][bigScreenChan];
      bigScreenDraw();
    }
  }
  if (touchX > 80 && touchX < 120 && touchY > 80 && touchY < 120 ) {
    ...
    if (bigScreen == true) {
      harmEnable[screen - 1][bigScreenChan] = !harmEnable[screen - 1][bigScreenChan];
      bigScreenDraw();
    }
  }
  if (touchX > 120 && touchX < 160 && touchY > 80 && touchY < 120) {
    ...
    if (bigScreen == true && harmEnable[screen - 1][bigScreenChan] == true ) {
      ++harmSemitones;
      bigScreenDraw();
    }
  }
  ...
  if (touchX < 40 && touchY > 120 && touchY < 160 ) {
    if (screen > 26 && moreScreensFlag == true) {
      ...
      if ( screen == 28 ) {
        harmonyArrayClear();
        harmChannel = 0;
        harmEnable[harmDevice][harmChannel] = !harmEnable[harmDevice][harmChannel];
        harmonyArrayPrint();
      }
      if ( screen == 27 ) {
        harmonyArrayClear();
        seqChannel = 0;
        recChannel = 1;
        seqEnable[seqDevice][seqChannel] = !seqEnable[seqDevice][seqChannel];
        sequencerArrayPrint();
      }
    }
  }
